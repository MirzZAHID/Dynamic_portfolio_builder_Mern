      ...
      <UserLayout>
        ...
        <div className="home">
          <div className="home-templates-cont">
            <h2 className="template-header-title">Carwash Busniess Portfolio Templates</h2>
            ...
            >
              {PortfolioTemplates.slice(6, 8).map((template) => {
                return (
                  <Box
                    key={template.id}
                    id="template"
...
export default connect(mapStateToProps, mapDispatchToProps)(CarwashTemplates);
