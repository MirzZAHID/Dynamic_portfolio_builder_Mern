      ...
      <UserLayout>
        ...
        <div className="home">
          <div className="home-templates-cont">
            <h2 className="template-header-title text-center m-2">Pharmacist Portfolio Templates</h2>
            <p className="template-select-text text-center">
            ...
            >
              {PortfolioTemplates.slice(0, 2).map((template) => {
                return (
                  <Box
                    key={template.id}
                    id="template"
...
export default connect(mapStateToProps, mapDispatchToProps)(PharmaTemplates);
