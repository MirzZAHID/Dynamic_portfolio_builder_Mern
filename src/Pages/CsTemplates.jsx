      ...
      <UserLayout>
        ...
        <div className="home">
          <div className="home-templates-cont">
            <h2 className="template-header-title">Computer Science Portfolio Templates</h2>
            ...
            >
              {PortfolioTemplates.slice(2, 4).map((template) => {
                return (
                  <Box
                    key={template.id}
                    id="template"
...
export default connect(mapStateToProps, mapDispatchToProps)(CsTemplates);
