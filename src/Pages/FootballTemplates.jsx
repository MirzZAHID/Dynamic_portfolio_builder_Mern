      ...
      <UserLayout>
        ...
        <div className="home">
          <div className="home-templates-cont">
            <h2 className="template-header-title">Football Portfolio Templates</h2>
            ...
            >
              {PortfolioTemplates.slice(8, 10).map((template) => {
                return (
                  <Box
                    key={template.id}
                    id="template"
...
export default connect(mapStateToProps, mapDispatchToProps)(FootballTemplates);
