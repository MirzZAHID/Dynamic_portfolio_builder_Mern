      ...
      <UserLayout>
        ...
        <div className="home">
          <div className="home-templates-cont">
            <h2 className="template-header-title">Cricket Portfolio Templates</h2>
            ...
            >
              {PortfolioTemplates.slice(10, 13).map((template) => {
                return (
                  <Box
                    key={template.id}
                    id="template"
                  ...
                  >
                    ...
                    <Button
                      ...
                      onClick={() => {navigateToFillDetails(template.id);localStorage.setItem('special',true)}}
                      size="medium"
                      variant="contained"
                      color="secondary"
                    >
...
export default connect(mapStateToProps, mapDispatchToProps)(CricketTemplates);
