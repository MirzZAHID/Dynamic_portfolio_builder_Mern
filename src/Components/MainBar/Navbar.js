          ...
          <AppBar component="nav" position="sticky" className="appbar" sx={{ color: "primary", boxShadow: "none" }}>
            <Toolbar id="toolbar">
              ...
              <Box sx={{ display: { xs: "none", sm: "block" } }}>
               ...
               <NavLink to="/" className="nav-link aboutUs" color="inherit">
                  Home
                </NavLink>
               ...
               <NavLink to="/about-us" className="nav-link aboutUs" color="inherit">
                ...
                <NavLink to="/contact" className="nav-link aboutUs" color="inherit">
                  Contact Us
                </NavLink>
               
               
               
                <NavLink to="/login" className="nav-link aboutUs loginLink" color="inherit">
                  Login
                </NavLink>
                <NavLink to="/signup" className="nav-link aboutUs registerLink" color="inherit">
                  Register
                </NavLink>
              </Box>
            </Toolbar>
