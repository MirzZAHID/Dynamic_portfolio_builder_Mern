  ...
  const drawer = (
    <Box onClick={handleDrawerToggle} sx={{ textAlign: "center" }}>
      ...
      <List
        ...
        <NavLink className="nav-link" to="/template" color="inherit">
          Resume Templates
        </NavLink>
        ...
        <NavLink to="/homeone" color="inherit" className="nav-link">
          HomePage
        </NavLink>
      </List>
    </Box>
          ...
          <AppBar component="nav" position="sticky" className="appbar" sx={{ color: "primary", boxShadow: "none" }}>
            <Toolbar id="toolbar">
              ...
              <Box sx={{ display: { xs: "none", sm: "block" } }}>
               ...
               <NavLink to="/template" className="nav-link aboutUs" color="inherit">
                  Home
                </NavLink>
               
               <NavLink to="/authabout-us" className="nav-link aboutUs" color="inherit">
                  About Us
                </NavLink>

                <NavLink to="/authcontact" className="nav-link aboutUs" color="inherit">
                  Contact Us
                </NavLink>
               
               
               
                <NavLink to="/profile" className="nav-link aboutUs loginLink" color="inherit">
                  Profile
                </NavLink>
              </Box>
            </Toolbar>
